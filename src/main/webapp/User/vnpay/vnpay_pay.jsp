    ...
    <body>
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="/CWU/vnpay" id="frmCreateOrder" method="post">        
                    ...
                    <div class="form-group">
                        ...
                        <label for="bankCode">Payment via ATM/Local Bank Account</label><br>

                        <!--                                                <input type="radio" id="bankCode" name="bankCode" value="INTCARD">
                                                                        <label for="bankCode">Thanh toán qua thẻ quốc tế</label><br>-->
                    </div>
                    <div class="form-group">
                        <h5>Select Interface Language for Payment</h5>
                        <input type="radio" id="language" Checked="True" name="language" value="vn">
                        <label for="language">Vietnamese</label><br>
                        <input type="radio" id="language" name="language" value="en">
                        <label for="language">English</label><br>
                    </div>
                    <button type="submit" class="btn btn-default btn-pay-now" href>Payment</button>
                </form>
            </div>
            <p>
                &nbsp;
